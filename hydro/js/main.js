(function($){
    ...
    var Lang = {
        ...
        it: {
            //Месяца
            months: ['Gennaio',' Febbraio',' Marzo ',' Aprile',' Maggio','Giu','Luglio',' Agosto',' Settembre','Ottobre','Novembre ','Dicembre'],
            //Месяца в родительcком падеже
            monthsRp: ['gennaio' , 'febbraio' , 'marzo' , 'aprile','maggio',' giu' , ' Luglio' , ' ggosto' , ' settembre' , ' ottobre ' , ' novembre ' , ' dicembre '],
            //Месяца в предложном падеже
            monthsPp: ['gennaio' , ' febbraio' , ' marzo ' , ' aprile',' maggio ' , ' giu' , ' luglio' , ' agosto' , ' settembre' , ' ottobre ' , ' novembre ' , ' dicembre '],
            maxPurchase: 'Il più grande di tutti gli ordini (_COUNT_) è stato di _DATE_ _MONTH_ 2017 anni.',
            stockInfoTitle: 'Più di 100 000 vendite in  ',
            stockInfoTime: 'Termini di validità dell\'offerta dal _STARTDATE_ _STARTMONTH_ al _ENDDATE_ _ENDMONTH_'
        }
    };
